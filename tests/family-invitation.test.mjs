...
void test('supervisor invitations include the public app, exact account, role, and setup instructions', () => {
...
void test('view-only invitation describes reading access without promising editing', () => {
...
void test('mailto safely encodes the recipient, subject, and full body with email line endings', () => {
...
void test('configured deployment links are included for other installations', () => {
...
void test('copy writes the complete invitation and only reports success after the clipboard resolves', async () => {
...
void test('missing or blocked clipboard access selects the manual-copy fallback', async () => {
